...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* HEADER */}
      <nav className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 px-4 sm:px-6 md:px-10 lg:px-28 py-6 border-b border-white/10">
        {/* LOGO */}
        <div onClick={() => navigate("/")} className="cursor-pointer">
          <h1 className="text-2xl sm:text-3xl font-black text-center lg:text-left">
            Centennial
        ...
        {/* RIGHT */}
        <div className="flex flex-wrap justify-center lg:justify-end gap-3 sm:gap-5 text-sm sm:text-base">
          <button
            onClick={() => navigate("/")}
