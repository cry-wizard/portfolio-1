  ...
  >
        ...
        <section className="relative z-10 px-6 md:px-16 lg:px-28 py-14">
          ...
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="flex flex-col justify-center lg:min-h-[650px]">
              ...
              <p id="hero" className="mt-10 text-xl text-white/80 leading-relaxed max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3 text-sm text-white/80">
                <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">⚡ No Hidden Charges</span>
                <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">💰 No VAT / GST</span>
                <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">🚀 3-Day Free Trial</span>
                <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">🌐 Free Hosting</span>
                <span className="px-4 py-2 rounded-full bg-white/5 border border-white/10">🛠 24/7 Support</span>
              </div>
    ...
    <div className="bg-black/30 rounded-3xl p-6 border border-white/5">
      ...
      <p className="text-white/70 mt-4 leading-relaxed">
        I design modern, user-centric digital experiences focused on usability,
    ...
    <div className="grid grid-cols-2 gap-5 mt-6">
      ...
      <div className="bg-black/30 rounded-3xl p-6 border border-white/5">
        ...
        <p className="text-white/50 text-sm mt-1">Completed successfully</p>
      </div>
  
      <div className="bg-black/30 rounded-3xl p-6 border border-white/5">
        <h4 className="text-white/70">Experience</h4>
        <p className="text-4xl font-black mt-3">5+ Yrs</p>
        <p className="text-white/50 text-sm mt-1">Industry experience</p>
      </div>
